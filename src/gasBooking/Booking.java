...
public class Booking extends GasConnection {
    ...
    public void getDates(){
        ...
        dt = new Scanner(System.in).nextLine(); //next() is when we want to add one thing
        dt_1 = null;
...
//                System.out.println("status : booked");
                ...
                lastDate = dt_1; //updating lastDate -> current booking data will become the last booking date
            }
