...
public class Main {
    ...
    // booking count, Cancel count , Delivered Count, Pending Count

    static String dpname; //delivered Person Name

    public static void cylinderCount(Delivery[] obj) //Passing object here
    {
